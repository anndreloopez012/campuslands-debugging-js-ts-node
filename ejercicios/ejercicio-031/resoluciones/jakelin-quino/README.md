...
## ¿Cómo lo encontré?
Ejecuté `npm test -- ejercicios/ejercicio-031/tests/luxury-cars.test.ts` y la prueba falló al calcular el promedio de registros activos y al obtener el mayor puntaje.
