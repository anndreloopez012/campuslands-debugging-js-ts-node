# Solución Ejercicio 031: Luxury Cars
...
```text
camper@campus-H610M-K-V2:~/campuslands-debugging-js-ts-node-Eve-1$ npm test -- ejercicios/ejercicio-031/tests/luxury-cars.test.ts

> campuslands-debugging-js-ts-node@1.0.0 test
> vitest run ejercicios/ejercicio-031/tests/luxury-cars.test.ts


 RUN  v4.1.10 /home/camper/campuslands-debugging-js-ts-node-Eve-1

 ✓ ejercicios/ejercicio-031/tests/luxury-cars.test.ts (2 tests) 2ms
   ✓ ejercicio 031 (2)
