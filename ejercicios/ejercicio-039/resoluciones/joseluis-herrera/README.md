# 🛠️ Reporte de Debugging — Ejercicio 039
...
> vitest run ejercicios/ejercicio-039/tests/movies.api.test.js


 RUN  v4.1.10 /home/joselo/Documentos/campuslands-debugging-js-ts-node

 ✓ ejercicios/ejercicio-039/tests/movies.api.test.js (3 tests) 41ms
   ✓ ejercicio 039 (3)
     ✓ responde health correctamente 24ms
     ✓ busca item por id numerico y devuelve 404 si no existe 7ms
     ✓ crea item con status 201 9ms

 Test Files  1 passed (1)
      Tests  3 passed (3)
   Start at  20:12:06
   Duration  314ms (transform 46ms, setup 0ms, import 145ms, tests 41ms, environment 0ms)
```