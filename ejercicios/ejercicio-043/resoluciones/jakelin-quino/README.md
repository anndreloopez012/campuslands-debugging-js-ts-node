...
## ¿Cómo lo encontré?
Ejecuté `npm test -- ejercicios/ejercicio-043/tests/pagination.api.test.js` y las peticiones HTTP retornaron códigos de estado incorrectos y fallos en la búsqueda por ID.
