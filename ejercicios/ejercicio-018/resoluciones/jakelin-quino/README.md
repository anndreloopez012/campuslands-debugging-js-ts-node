...
## ¿Cómo lo encontré?
Ejecuté `npm test -- ejercicios/ejercicio-018/tests/formula-parser.test.js` y obtuve fallos en la suma de puntos concatenada ('10155') y en el orden descendente del ranking.
