# 🛠️ Reporte de Debugging — Ejercicio 024
...
> vitest run ejercicios/ejercicio-024/tests/space-missions.test.ts
 ...
 ✓ ejercicios/ejercicio-024/tests/space-missions.test.ts (2 tests) 7ms
   ✓ ejercicio 024 (2)
 ...
 Test Files  1 passed (1)
      Tests  2 passed (2)
   Start at  17:20:35
   Duration  302ms (transform 54ms, setup 0ms, import 78ms, tests 7ms, environment 0ms)
```