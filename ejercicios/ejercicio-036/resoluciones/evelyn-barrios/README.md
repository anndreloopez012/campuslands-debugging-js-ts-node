# Solución Ejercicio 036: API de Items
...
1.  **Comparación de tipos**: `req.params.id` es siempre un string, y la comparación estricta (`===`) con un `number` fallaba.
...
```text
camper@campus-H610M-K-V2:~/campuslands-debugging-js-ts-node-Eve-1$ npm test -- ejercicios/ejercicio-036/tests/motos.api.test.js

> campuslands-debugging-js-ts-node@1.0.0 test
> vitest run ejercicios/ejercicio-036/tests/motos.api.test.js


 RUN  v4.1.10 /home/camper/campuslands-debugging-js-ts-node-Eve-1

 ✓ ejercicios/ejercicio-036/tests/motos.api.test.js (3 tests) 25ms
   ✓ ejercicio 036 (3)
 ...
 Test Files  1 passed (1)
      Tests  3 passed (3)
   Start at  09:59:11
   Duration  179ms (transform 16ms, setup 0ms, import 77ms, tests 25ms, environment 0ms)
