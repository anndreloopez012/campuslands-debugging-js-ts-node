# 🛠️ Reporte de Debugging — Ejercicio 036
...
> vitest run ejercicios/ejercicio-036/tests/motos.api.test.js
 ...
 ✓ ejercicios/ejercicio-036/tests/motos.api.test.js (3 tests) 44ms
   ✓ ejercicio 036 (3)
     ✓ responde health correctamente 28ms
     ✓ busca item por id numerico y devuelve 404 si no existe 6ms
     ✓ crea item con status 201 10ms

 Test Files  1 passed (1)
      Tests  3 passed (3)
   Start at  20:04:27
   Duration  314ms (transform 47ms, setup 0ms, import 141ms, tests 44ms, environment 0ms)
```