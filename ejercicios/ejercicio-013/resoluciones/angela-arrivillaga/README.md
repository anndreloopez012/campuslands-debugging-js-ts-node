# Documentación de Debugging - Ejercicio 013

## Descripción
Se corrigieron los errores lógicos en el módulo de costos de viaje para cumplir con las pruebas de validación automatizadas.
