...
## ¿Cómo lo encontré?
Ejecuté `npm test -- ejercicios/ejercicio-011/tests/battle-zone.test.js` y obtuve fallos en la suma de puntos concatenada ('10155') y en el orden descendente del ranking.
