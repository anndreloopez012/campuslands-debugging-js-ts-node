...
## ¿Cómo lo encontré?
Ejecuté `npm test -- ejercicios/ejercicio-038/tests/inventory.api.test.js` y las peticiones HTTP retornaron códigos de estado incorrectos y fallos en la búsqueda por ID.
