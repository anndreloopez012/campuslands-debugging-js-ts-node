# 🛠️ Reporte de Debugging — Ejercicio 020
...
> vitest run ejercicios/ejercicio-020/tests/esports-team.test.ts
 ...
 ✓ ejercicios/ejercicio-020/tests/esports-team.test.ts (2 tests) 7ms
   ✓ ejercicio 020 (2)
     ✓ calcula promedio solo con registros activos 3ms
     ✓ obtiene el registro con mayor puntaje 1ms

 Test Files  1 passed (1)
      Tests  2 passed (2)
   Start at  17:06:55
   Duration  312ms (transform 62ms, setup 0ms, import 86ms, tests 7ms, environment 0ms)
```