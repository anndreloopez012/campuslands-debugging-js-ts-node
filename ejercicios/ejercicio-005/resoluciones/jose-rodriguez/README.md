# Resolución Ejercicio 004: Moba Ranking
...
- *Nota técnica:* Se identificó una inconsistencia en la plantilla del repositorio, ya que el README general menciona "descuento y redondeo de precios"[cite: 5], pero los tests y el código base evalúan la lógica de suma de puntos y ranking. Se priorizó hacer pasar el contrato definido por los tests.
