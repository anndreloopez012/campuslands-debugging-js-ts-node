...
## ¿Cómo lo encontré?
Ejecuté `npm test -- ejercicios/ejercicio-017/tests/pingpong.test.js` y obtuve fallos en la suma de puntos concatenada ('10155') y en el orden descendente del ranking.
