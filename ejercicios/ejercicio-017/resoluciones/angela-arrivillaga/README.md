# Documentación de Debugging - Ejercicio 017

## Descripción
Se corrigieron los errores lógicos en el módulo de ping pong para cumplir con las pruebas de validación automatizadas.
