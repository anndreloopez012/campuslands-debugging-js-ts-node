# 🛠️ Reporte de Debugging — Ejercicio 015
---
...
> vitest run ejercicios/ejercicio-015/tests/layers.test.js


 RUN  v4.1.10 /home/joselo/Documentos/campuslands-debugging-js-ts-node

 ✓ ejercicios/ejercicio-015/tests/layers.test.js (2 tests) 5ms
   ✓ ejercicio 015 (2)
 ...
 Test Files  1 passed (1)
      Tests  2 passed (2)
   Start at  16:21:24
   Duration  283ms (transform 46ms, setup 0ms, import 71ms, tests 5ms, environment 0ms)
```