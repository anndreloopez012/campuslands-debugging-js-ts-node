# Documentación de Debugging - Ejercicio 015

## Descripción
Se corrigieron los errores lógicos en el módulo de capas para cumplir con las pruebas de validación automatizadas.
