# Documentación de Debugging - Ejercicio 012

## Descripción
Se corrigieron los errores lógicos en el módulo de kickboxing para cumplir con las pruebas de validación automatizadas.
