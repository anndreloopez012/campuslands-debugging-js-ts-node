# 🛠️ Reporte de Debugging — Ejercicio 029
...
> vitest run ejercicios/ejercicio-029/tests/damage-engine.test.ts
 ...
 ✓ ejercicios/ejercicio-029/tests/damage-engine.test.ts (2 tests) 5ms
   ✓ ejercicio 029 (2)
 ...
 Test Files  1 passed (1)
      Tests  2 passed (2)
   Start at  17:51:15
   Duration  294ms (transform 57ms, setup 0ms, import 82ms, tests 5ms, environment 0ms)
```