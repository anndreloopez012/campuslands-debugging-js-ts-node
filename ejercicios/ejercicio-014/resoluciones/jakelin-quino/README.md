...
## ¿Cómo lo encontré?
Ejecuté `npm test -- ejercicios/ejercicio-014/tests/tattoo-agenda.test.js` y obtuve fallos en la suma de puntos concatenada ('10155') y en el orden descendente del ranking.
