...
## ¿Cómo lo encontré?
Ejecuté `npm test -- ejercicios/ejercicio-050/tests/final-api.api.test.js` y las peticiones HTTP retornaron códigos de estado incorrectos y fallos en la búsqueda por ID.
