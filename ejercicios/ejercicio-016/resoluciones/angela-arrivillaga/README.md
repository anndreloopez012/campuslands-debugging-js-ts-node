# Documentación de Debugging - Ejercicio 016

## Descripción
Se corrigieron los errores lógicos en el módulo de vueltas de carreras para cumplir con las pruebas de validación automatizadas.
