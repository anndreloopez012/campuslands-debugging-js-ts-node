# Documentación de Debugging - Ejercicio 008

## Descripción
Se corrigieron los errores lógicos en el módulo de la tabla de futsal para cumplir con las pruebas de validación automatizadas.
