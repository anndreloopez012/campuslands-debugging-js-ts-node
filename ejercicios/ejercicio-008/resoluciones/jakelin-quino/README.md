...
## ¿Cómo lo encontré?
Ejecuté `npm test -- ejercicios/ejercicio-008/tests/futsal-table.test.js` y obtuve fallos en la suma de puntos concatenada ('10155') y en el orden descendente del ranking.
