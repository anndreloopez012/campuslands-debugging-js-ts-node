# 🛠️ Reporte de Debugging — Ejercicio 030
...
> vitest run ejercicios/ejercicio-030/tests/moba-build.test.ts
 ...
 ✓ ejercicios/ejercicio-030/tests/moba-build.test.ts (2 tests) 5ms
   ✓ ejercicio 030 (2)
 ...
 Test Files  1 passed (1)
      Tests  2 passed (2)
   Start at  17:53:59
   Duration  281ms (transform 54ms, setup 0ms, import 77ms, tests 5ms, environment 0ms)
```