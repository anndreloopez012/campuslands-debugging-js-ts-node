# 🛠️ Reporte de Debugging — Ejercicio 003
---
...
> vitest run ejercicios/ejercicio-003/tests/skins.test.js
 ...
 ✓ ejercicios/ejercicio-003/tests/skins.test.js (2 tests) 3ms
   ✓ ejercicio 003 (2)
     ✓ calcula suma numerica y no concatena texto 1ms
     ✓ ordena ranking de mayor a menor puntaje 1ms

 Test Files  1 passed (1)
      Tests  2 passed (2)
   Start at  12:50:14
   Duration  184ms (transform 41ms, setup 0ms, import 59ms, tests 3ms, environment 0ms)
```